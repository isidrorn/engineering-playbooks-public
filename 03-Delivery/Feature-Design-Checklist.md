...
□ Data model and ownership boundaries sketched out
...
□ Backward compatibility and migration path considered if replacing something live

### 📝 Plan
□ Work broken into independently shippable increments
□ Feature flag or kill switch planned if risk warrants it
□ Observability requirements defined alongside the feature, not after (metrics, logs, traces)
